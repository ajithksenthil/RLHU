...
class PsychologicalProfiler:
    ...
    def update_profile(self, new_message: str, context: str = "general") -> Tuple[str, float]:
        try:
            ...
            print("pairing_analysis ", pairing_analysis)
            ...
            print("most_likely pairing: ", most_likely_pairing)
            # Update counts
